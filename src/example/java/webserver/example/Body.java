...
TODO PFR En raison de l approche KISS pour ce projet, on va peut etre eviter une anotation @Validate sur chaque endpoint et simplement utiliser une interface ValidationTrait
 ...
 Par ailleurs, l'avantage de cette approche est que l'on peut faire des controles plus specifiques si 2 fields sont dependants en terme de logique. (la ou imposer une validation field par field les isolerait)
